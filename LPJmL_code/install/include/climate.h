...
typedef struct
{
  ...
  Climatefile file_vpd;    /**< VPD input file */
...
#define getcellvpd(climate,cell) (climate->data.vpd + (cell)*NMONTH)
...
extern Bool openinputdata(Infile *,const Filename *,const char *,const char *,int,
...
/* in include/climate.h (or another header included by both dailyclimate.c and turnover_daily_tree.c) */
//extern Dailyclimate *current_daily;   /* pointer to daily struct for the cell currently being processed */
