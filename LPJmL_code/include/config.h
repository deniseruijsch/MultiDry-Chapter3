...
struct config
{
  ...
  Bool drought_mortality;   /**< enable drought mortality (TRUE/FALSE) */
  Bool drought_phenology;   /**< enable drought mortality (TRUE/FALSE) */
  Bool monthly_mortality; /**< enable monthly mortality (TRUE/FALSE) */
