...
BASE_CONFIG_DIR = "/home/druijsch/LPJmL5/dev15oct2025/config_files/2026_04_08_run_for_10_locations/boreal_needleleaved_summergreen_tree"
LPJ_BIN = "/home/druijsch/LPJmL5/dev15oct2025/install/bin/lpjml"
OUTPUT_DIR = "/projects/prjs2023/chapter3/lpjml_output/2026_04_08_run_for_10_locations/boreal_needleleaved_summergreen_tree"
...
def make_trial_config(trial_number, num_patches=10):
    ...
    for patch_idx in range(1, num_patches + 1):
        ...
        input_file = os.path.join(
            BASE_CONFIG_DIR,
            "spinup", "configs",
            f"boreal_needleleaved_summergreen_tree_patch{patch_idx}_input.cjson"
        )

        base_cfg = os.path.join(BASE_CONFIG_DIR, "boreal_needleleaved_summergreen_tree_config_optuna.cjson")

        # Restart filename for this patch
        restart_filename = os.path.join(
            "/home/druijsch/LPJmL5/dev15oct2025/restart/2026_04_08_run_for_10_locations/boreal_needleleaved_summergreen_tree",
            patch_name,
